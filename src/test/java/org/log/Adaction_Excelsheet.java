...
public class Adaction_Excelsheet extends ADACTION {
	public static void main(String[] args) throws IOException {
		Adaction_Excelsheet A = new Adaction_Excelsheet();
		...
		String excelread5 = A.excelread("F:\\Hari\\Table.xlsx", "AKI", 1, 2);
		WebElement locator6 = A.locator("id","room_type");
		A.selectByValue(locator6,excelread5 );
		String excelread6 = A.excelread("F:\\Hari\\Table.xlsx", "AKI", 1, 3);
		WebElement locator7 = A.locator("id","room_nos");
		A.selectByValue(locator7,excelread6 );
		WebElement locator8 = A.locator("id","datepick_in");
		A.Clear(locator8);
		String excelread7 = A.excelread("F:\\Hari\\Table.xlsx", "AKI", 1, 4);
		WebElement locator8a = A.locator("id","datepick_in");
		A.sendText(locator8a, excelread7);
		
		
		
		
	/*	WebElement locator8b = A.locator("id","datepick_out");
		A.Clear(locator8b);
		String excelread7a = A.excelread("F:\\Hari\\Table.xlsx", "AKI", 1, 5);
		WebElement locator8c = A.locator("id","datepick_in");
		A.sendText(locator8c, excelread7a);
		*/
		
		
		String excelread8 = A.excelread("F:\\Hari\\Table.xlsx", "AKI", 1, 6);
		WebElement locator9 = A.locator("id","adult_room");
		int parseInt3 = Integer.parseInt(excelread8);
		A.selectByIndex(locator9, parseInt3);
		String excelread9 = A.excelread("F:\\Hari\\Table.xlsx", "AKI", 1, 7);
		...
		WebElement locator23 = A.locator("id", "order_no");
		String gettingAttribute = A.gettingAttribute(locator23, "value");
		A.excelWrite("F:\\Hari\\Table.xlsx", "AKI", 0, 10, gettingAttribute);
